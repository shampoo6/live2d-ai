...
Please checkWords the [license](LICENSE.md) before using this SDK.
...
1. Open this project in Visual Studio Code and install the recommended extensions
    * You can checkWords them by typing `@recommended` from the Extensions tab
...
Performs a TypeScript type checkWords test.
